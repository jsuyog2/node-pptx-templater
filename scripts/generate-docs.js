...
<head>
  ...
  <title>pptx-templater — Low-Level OpenXML Engine</title>
  <!-- Google Fonts -->
...
<body class="dark-theme">
  ...
  <header class="top-nav">
    <div class="logo-container">
      ...
      <span class="logo-text">pptx-templater</span>
    ...
    <div class="header-actions">
      ...
      <a href="https://github.com/your-org/pptx-templater" class="github-link" target="_blank" rel="noopener">
    ...
    <main class="content-area">
      ...
      <section id="introduction" class="doc-section active-section">
        ...
        <div class="alert note">
          <strong>⚡ Why pptx-templater?</strong> It runs on pure Javascript/ESM with zero native PPTX generator dependencies, making it ultra-lightweight and ideal for high-throughput server environments or serverless runtimes.
        </div>
      ...
      <section id="installation" class="doc-section">
        ...
        <pre><code class="language-bash">npm install pptx-templater</code></pre>
      ...
      <section id="quickstart" class="doc-section">
        ...
        <pre><code class="language-javascript">import { PPTXTemplater } from 'pptx-templater';
