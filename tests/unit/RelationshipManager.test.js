...
describe('RelationshipManager', () => {
  ...
  describe('getRelsPath()', () => {
    it('should compute correct .rels path for a file', () => {
      expect(manager.getRelsPath('ppt/slides/slide1.xml'))
        .toBe('ppt/slides/_rels/slide1.xml.rels');
    });

    it('should handle root-level files', () => {
      expect(manager.getRelsPath('ppt/presentation.xml'))
        .toBe('ppt/_rels/presentation.xml.rels');
    });
  });
